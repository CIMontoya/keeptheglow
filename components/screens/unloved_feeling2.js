...
class UnlovedFeeling2 extends Component {
 ...
 constructor(props) {
  ...
  storeListItem = () => {
    ...
    console.log(this.props.createListItem, "unloved feeling 2")

    this.props.createListItem(listItem)
    this.props.navigation.navigate('UnlovedFeeling3')
...
console.log(this.props.list_items, "unloved Feeling 1")
...
export default connect(mapStateToProps, mapDispatchToProps)(UnlovedFeeling2)
